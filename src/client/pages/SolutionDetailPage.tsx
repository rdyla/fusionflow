  ...
  return (
    <div style={{ maxWidth: 960, margin: "0 auto" }}>
      ...
      {/* Slim solution meta — solution name (with inline rename) + customer
          ...
          in their own card lower on the page so the header stays read-once. */}
      ...
      {/* Header — types + status pills + terminal-state actions. The
          rename UI lives in the slim meta card above; the Advance button
          was retired with the status auto-derivation (May-2026). */}
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 20, marginBottom: 24, flexWrap: "wrap" }}>
        ...
        {/* Status actions — Advance retired May-2026 (status auto-derives
            from NA / LE / SOW artifacts). Only the terminal-state controls
            stay manual. */}
        {canEdit && (
