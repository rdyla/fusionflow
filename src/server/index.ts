...
import myTimeRoutes from "./routes/myTime";
...
app.route("/api/projects", stageRoutes);
app.route("/api/projects", taskRoutes);
app.route("/api/projects", cascadeRoutes);
...
app.route("/api/my-time", myTimeRoutes);
...
app.route("/api/help-requests", helpRequestRoutes);
app.route("/api/projects", meetingPrepRoutes);
