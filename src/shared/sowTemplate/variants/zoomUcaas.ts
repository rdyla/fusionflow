...
export const ZOOM_UCAAS_VARIANT: SowVariant = {
  ...
  phases: [
    // ── 2.2 Initiation ────────────────────────────────────────────────────────
    {
      ...
      subsections: [
        ...
        {
          title: "Internal project assets.",
          intro: "Created by Packet Fusion before customer kickoff:",
          bullets: [
            "Customer Engagement (CE) case opened for the project.",
            "SharePoint folder provisioned for project artifacts; link shared with Customer.",
            "Internal chat channel created for cross-functional collaboration.",
            "Contract and SOW reviewed by the assigned PM.",
            "Project distribution email group created and validated with Help Desk.",
          ],
        },
        {
          title: "Kickoff.",
          bullets: [
            "Internal kickoff: PM, IE, and any supporting roles align on scope, schedule, and risks.",
            "Customer kickoff: scheduled within five (5) business days of project assignment. PM delivers the kickoff deck, AI-generated meeting summary is shared, recurring cadence meetings are scheduled, and the first technical session is calendared.",
      ...
      subsections: [
        {
          ...
          bullets: [
            "Confirm Packet Fusion access to Customer's Zoom tenant.",
            "Confirm licenses and hardware in scope.",
            "Provide Customer with required network port and firewall data; review against Customer's current configuration.",
            "Extract call flow and database from the legacy system for documentation and validation.",
            "Document users, sites, locations, and DIDs for Customer validation.",
            "Document phone make, model, and MAC IDs for any in-scope physical endpoints.",
            "Document existing call flows for Customer validation.",
            ...
            "Determine client software installation method (e.g., MSI installer for managed desktops).",
            "Complete network assessment and document results.",
            "Confirm settings at Personal, Account, Group, and Role levels.",
          ],
        },
        {
          number: "2.3.2",
        ...
        },
        {
          ...
          bullets: [
            "Packet Fusion prepares end-user communication templates.",
            "Communication strategy reviewed with Customer.",
            "Customer sends end-user pre-Go-Live communications.",
          ],
        },
      ],
    },
    ...
    // ── 2.4 Executing ─────────────────────────────────────────────────────────
    {
      ...
      subsections: [
        ...
        },
        {
          ...
          bullets: [
            "Client software / app prepared for download and installation on Customer PCs.",
            "Confirm users have Zoom accounts.",
            "Build Sites, Auto-Receptionists (ARs), and Call Flows per the validated design.",
            "Assign numbers to users, ARs, Call Queues (CQs), Common-Area Phones (CAPs), etc.",
            "Build integrations (e.g., MS Teams, SSO, calendar).",
            "Configure settings at Account, Site, Group, and User levels.",
            "Upload MAC addresses for desk phones.",
            "Configure desk-phone button assignments.",
    ...
    // ── 2.5 Monitoring / Controlling ──────────────────────────────────────────
    {
      ...
      subsections: [
        ...
        },
        {
          ...
          bullets: [
            "Deploy hardware (desk phones, ATAs, etc.).",
            "Boot and register phones to the cloud.",
            "Assign profiles to devices.",
            "Configure Caller ID (CLID) for outbound calls.",
            "Packet Fusion provides UAT test form to Customer.",
            "Customer tests call flows.",
            "Customer tests E911 by dialing 933.",
            "Customer tests analog devices.",
            "Packet Fusion and Customer review UAT results together.",
    ...
    // ── 2.6 Go-Live / Production ──────────────────────────────────────────────
    {
      ...
      subsections: [
        ...
        },
        {
          ...
          title: "Communications",
          bullets: [
            "Customer sends end-user Go-Live communications.",
          ],
        },
        {
          number: "2.6.4",
  ...
  deliverables: [
    ...
    { id: "D4",  name: "Network Readiness Review",           format: "PDF",                    acceptanceCriteria: "Wired/wireless test results delivered per site; identified risks documented; Customer acknowledges remediation responsibilities." },
