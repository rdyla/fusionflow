...
export const SCOPE_ITEMS: ScopeItem[] = [
  ...
  // ── UCaaS ───────────────────────────────────────────────────────────────
  { appliesTo: ["ucaas"], vendor: ["zoom"],        element: "Zoom Phone users (UCaaS)", quantity: "{ucaas_seats}", notes: "No physical fax, overhead paging, or physical desk phones in base scope.", sortOrder: 20 },
  { appliesTo: ["ucaas"], vendor: ["ringcentral"], element: "RingCentral users (UCaaS)", quantity: "{ucaas_seats}", notes: "No physical fax, overhead paging, or physical desk phones in base scope.", sortOrder: 20 },
  ...
  // ── CCaaS ───────────────────────────────────────────────────────────────
  { appliesTo: ["ccaas"], vendor: ["zoom"],        element: "Zoom Contact Center agents", quantity: "{ccaas_agents}", notes: "Agent licensing in scope; supervisor + admin profiles configured.", sortOrder: 20 },
  { appliesTo: ["ccaas"], vendor: ["ringcentral"], element: "RingCX agents",              quantity: "{ccaas_agents}", notes: "Agent licensing in scope; supervisor + admin profiles configured.", sortOrder: 20 },
  ...
  { appliesTo: ["ci"], element: "Recorded seats",                   quantity: "{ci_seats}",  notes: "Users whose conversations are captured for review and scoring.",                                  sortOrder: 20 },
  ...
  { appliesTo: ["wfm"], element: "WFM-managed agents",             quantity: "{ccaas_agents}", notes: "Agents synchronized into Workforce Management for forecasting and scheduling.",                  sortOrder: 20 },
  ...
  { appliesTo: ["qm"], element: "QM-evaluated agents",             quantity: "{ccaas_agents}", notes: "Agents whose interactions are captured and scored for quality evaluation.",                      sortOrder: 20 },
